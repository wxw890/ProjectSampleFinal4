...
<form action="condition.book" method="post" style="width:800px; height:200px; margin-top: 30px; margin-bottom: 30px; margin-left: 30px; margin-right: 30px;">
   ...
   <input type="text" name="value" id="value1" title="검색어입력" placeholder="검색어를 입력하세요" style="width: 500px; height:30px; float:left;" />
   ...
   <input type="text" name="secondvalue" id="value1" title="검색어입력" placeholder="2차 검색어를 입력하세요" style="width: 500px; height:30px; float:left;"/>
   ...
   <input type="text" name="thirdvalue" id="value1" title="검색어입력" placeholder="3차 검색어를 입력하세요" style="width: 500px; height:30px; float: left"/>
   <br/><br /><br /><br /><br /><br />
   <input type="submit" value="검색" style="width:50px; height:30px;  float:left; clear: left;"/>
</form>
</div>
